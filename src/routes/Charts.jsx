		...
		<PageContainer customSx={{ gap: 4 }}>
			...
			<ChartGrid>
				<ChartCard
					...
					description="Revenue over time from ticket sales"
				>
					<SimpleLineChart
				...
				<ChartCard
					...
					description="Weekly ticket sales"
				>
					<SimpleBarChart
						layout="horizontal"
						yAxis={[
			...
			<ChartGrid>
				<ChartCard
					...
					description="Ticket sales over time"
				>
					<SimpleLineChart
			...
			<ChartGrid>
				<ChartCard
					...
					description="Pres-sale ticket sales"
				>
					<SimpleBarChart
						xAxis={[
							{
				...
				<ChartCard
					...
					description="Day-of ticket sales"
				>
					<SimpleBarChart
						layout="horizontal"
						yAxis={[
				...
				<ChartCard
					...
					description="Pre-sale and day-of ticket sales"
				>
					<SimpleBarChart
						xAxis={[
							{
			...
			<ChartGrid>
				<ChartCard
					...
					description="Ticket price over time"
				>
					<SimpleLineChart
						dataset={MINI_TIMESERIES}
						xAxis={[
			...
			<ChartGrid>
				...
				<ChartCard
					title="Plain Scatter Plot"
					description="Ticket Prices by # Purchased"
				>
					<SimpleScatterChart
						slotProps={{
							legend: { hidden: true },
